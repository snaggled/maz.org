...
The Rails front end just pulls the most recent 30 activities from the collection and shows them in reverse chronological order. Rails is way overkill for this, but part of the exercise was learning how to use "MongoMapper":http://mongomapper.com.
